...
This project uses gqlgen, [https://github.com/99designs/gqlgen](https://github.com/99designs/gqlgen), a GraphQL library for go. It is a schema-first library. I prefer schema-first coming from a Apollo GraphQL experience.
